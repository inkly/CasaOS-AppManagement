...
The compose editor in an app's settings is a dashboard feature. The endpoint it saves through, `PUT /v2/app_management/compose/{id}`, is upstream; what this fork changed behind it is the `$` handling above.
